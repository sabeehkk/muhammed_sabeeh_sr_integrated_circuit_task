...
//           &#9776;
//         </button>
//         <h1 className="text-4xl font-bold text-[#fbfbfb] ml-2 lg:ml-0">
...
//         <a href="#tools" className="text-[#000000] font-semibold hover:rounded-full px-4 py-1 hover:bg-[#efefef]">Menu</a>
//         <a href="#pricing" className="text-[#000000] font-semibold hover:rounded-full px-4 py-1 hover:bg-[#efefef]">Tools</a>
//         <a href="#support" className="text-[#000000] font-semibold hover:rounded-full px-4 py-1 hover:bg-[#efefef]">Pricing</a>
  ...
  return (
    <header className="relative flex justify-between items-center header">
      ...
      <nav className="hidden lg:flex space-x-8">
        ...
        <a href="#support" className="text-[#000000] font-semibold hover:rounded-full px-4 py-1 hover:bg-[#efefef]">Category</a>
        <button className="bg-gray-50 text-[#000000] font-semibold border-none border-[#435933] rounded-full px-4 py-1 hover:bg-gray-100 transition">Signup</button>
      </nav>
    </header>
  );
